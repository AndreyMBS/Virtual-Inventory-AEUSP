...
{
    public partial class FrmPrincipalSalud : System.Web.UI.Page
    {
...
#pragma warning restore CS0246 // El nombre del tipo o del espacio de nombres 'AEUSP' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["Usuario"] != null)
            {
                ...
                else if (!organismo1.Single().ToString().Equals("SA1") && !organismo2.Single().ToString().Equals("IF1") && !organismo3.Single().ToString().Equals("AS1"))
                {
        ...
        protected void btn_RegistrarBoleta_Click(object sender, EventArgs e)
        {
            Response.Redirect("FrmRegistrarBoleta-SA.aspx");
        }

        protected void btn_RgistrarConsumible_Click(object sender, EventArgs e)
        {
            Response.Redirect("FrmRegistroConsumibles-SA.aspx");
        }
    }
}