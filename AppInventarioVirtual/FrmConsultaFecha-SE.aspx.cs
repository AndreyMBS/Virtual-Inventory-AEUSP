...
{
    public partial class FrmConsulta_SE : System.Web.UI.Page
    {
...
#pragma warning restore CS0246 // El nombre del tipo o del espacio de nombres 'AEUSP' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
        ...
        protected void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            if (verificar())
            {
                if (DDLMovimiento.SelectedItem.ToString() == "Entrada")
                {
                    FillGVAsistencias(DDLMovimiento.SelectedValue.ToString(), DateTime.Parse(txtFechaI.Text), (DateTime.Parse(txtFechaF.Text).AddDays(1)));
