...
{
    public partial class FrmPrincipalColchones : System.Web.UI.Page
    {
...
#pragma warning restore CS0246 // El nombre del tipo o del espacio de nombres 'AEUSP' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
        ...
        protected void registrarColchon_Click(object sender, EventArgs e)
        {
            Response.Redirect("FrmRegistroColchones.aspx");
        }

        protected void prestamoColchones_Click(object sender, EventArgs e)
        {
