...
{
    public partial class FrmPrincipalUsuarios : System.Web.UI.Page
    {
...
#pragma warning restore CS0246 // El nombre del tipo o del espacio de nombres 'AEUSP' no se encontró (¿falta una directiva using o una referencia de ensamblado?)
        ...
        protected void registrarUsuarios_Click(object sender, EventArgs e)
        {
            Response.Redirect("FrmRegistroUsuarios.aspx");
        }
    }
}